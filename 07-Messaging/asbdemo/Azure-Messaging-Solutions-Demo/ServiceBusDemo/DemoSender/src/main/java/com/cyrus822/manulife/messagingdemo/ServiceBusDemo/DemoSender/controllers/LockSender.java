...
public class LockSender {
    ...
    @PostMapping("/PeekLock/{waitFor}")
    public String withSessionIdByJMS(@PathVariable("waitFor")int waitFor, @RequestBody Payment payment) {
        String rtnMsg = "";
